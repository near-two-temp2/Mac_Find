/*
 * csearchfs.h — C shim exposing macOS searchfs() to Swift (Road_C fallback engine).
 *
 * Road_C is the hybrid flagship: the self-built mmap index is primary, and this
 * searchfs() driver is the fallback used when the index is missing/stale/corrupt.
 *
