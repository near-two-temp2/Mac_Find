 ...
 *
 * The per-result output/filtering of the original is replaced by a callback so
 * the Swift layer owns collection, limits, cancellation and higher-level filters.
 */
